...
DNPDRP_rawdata = readtable('data/DNPDR_data.xlsx', 'Sheet', 'DNPDRP', 'VariableNamingRule', 'preserve');
...
% (subtotal 17 variables) PDSS_year, PDSS_month, PDSS_score x 15, 
% (subtotal 4 variables) Hue_year, Hue_month, Hue_Rt, Hue_Lt
DNPDRC_rawdata = readtable('data/DNPDR_data.xlsx', 'Sheet', 'DNPDRC', 'VariableNamingRule', 'preserve');
